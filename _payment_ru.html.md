...
* [Провайдеры перевода на карту](#cards).
...
Также идентификатор нужного провайдера можно установить [поиском по ключевым словам](#provider-search).
...
Запрос выполняет денежный перевод на карты платежных систем Visa, MasterCard или МИР. Рекомендуется предварительно [узнать идентификатор провайдера по номеру карты](#card_check).
...
* Идентификатор другого интернет-провайдера или благотворительного фонда. Воспользуйтесь [поиском провайдера по ключевым словам](#provider-search).
...
Используйте API для поиска идентификатора провайдера. В запросе указывается список ключевых слов, по которым можно найти провайдера (например, название).
...
**searchPhrase** — строка ключевых слов, разделенных пробелами.
