...
2. Во всплывающем окне выберите разрешения на операции с токеном и нажмите **Продолжить**:
    ...
    * *Управление виртуальными картами* - API управления и выпуска [карт QIWI-Мастер](#qiwi-master) (для доступа к API добавьте опции *Запрос информации о профиле кошелька*, *Проведение платежей без SMS*)
