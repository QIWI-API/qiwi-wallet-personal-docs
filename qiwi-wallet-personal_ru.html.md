...
###### Последнее обновление: 2020-07-06 | [Предложить свои правки на GitHub](https://github.com/QIWI-API/qiwi-wallet-personal-docs/blob/master/qiwi-wallet-personal_ru.html.md)
...
* Нажмите **Выпустить новый токен**. Во всплывающем окне выберите разрешения на операции с токеном:
    ...
    * Проведение платежей без SMS - выполнение [платежных запросов](#payments) без подтверждения по SMS (независимо от настроек безопасности <https://qiwi.com/settings/options/security.action>), [оплата счетов](#pay_invoice), использование [уведомлений](#webhook)
